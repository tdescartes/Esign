...
import type { AuthUser, CertificateResponse, RecipientStatus } from "@esign/shared";
import { completeSigning, createDocument, fillField, getCertificate, getHealth, getMe, logOut, openPortal, sendDocument, uploadDocumentFile } from "./api";
...
export function App() {
    ...
    const sendDraft = async () => {
        ...
        try {
            ...
            if (pdfFile) {
                await uploadDocumentFile(created.id, pdfFile);
            }
    ...
    if (authState.status === "anonymous") {
        return <AuthGate onAuthenticated={(user) => setAuthState({ status: "authenticated", user })} />;
    }

    return (
        <main className="app-shell">
            <section className="hero-card">
                <div className="eyebrow">Esign migration workspace</div>
                ...
                <div className="status-row">
                    ...
                    <button
                        ...
                        onClick={() => {
                            void logOut().finally(() => setAuthState({ status: "anonymous" }));
                        }}
                        type="button"
                    >
                        Sign out
